...
Each changeset was monitored using the tag [#PCTOMarconi2026](https://resultmaps.neis-one.org/osm-changesets?comment=PCTOMarconi2026). The link opens a map covering a large area, because pupils have also mapped regions including the United Kingdom, Saudi Arabia, the Maldives and Algeria, where they were born or have lived. It is evident that the primary location of the workshop is the town of Pesaro (Italy), with a significant number of changesets having been recorded there.

For the purposes of this workshop, all the 25 pupils have created an account of OpenStreetMap. The tools *[Your OSM Heat Map](https://yosmhm.neis-one.org/)* and *[How did you contribute to OSM?](https://hdyc.neis-one.org/)* were used to display the area mapped by the pupils. Furthermore, *[Filtering OSM Changesets by a Specific Comment](https://resultmaps.neis-one.org/osm-changesets)* was used for measuring the global progress of the project and the average work of each pupil.

Eventually, the *[OSMfight](https://osmfight.neis-one.org/)* tool was adopted for the activity’s gamification. This tool allows two pupils to compare their contributions. These activities are merely games, but they are useful for stimulating pupils in their mapping activities.

## OpenStreetMap as OER
...
Another significant initiative that merits attention is the ‘[Project of the Month](https://osmit-podoma.wmcloud.org/)’, an instance of [Podoma](https://wiki.openstreetmap.org/wiki/Podoma) project. The Project of the Month is an informal initiative by the Italian community focused on a specific OpenStreetMap topic each month, subsequently discussed on the OSM Community Forum. This initiative is useful for encouraging pupils to work on a specific topic and to grow a sense of community with others OpenStreetMap users.
...
Furthermore, pupils have created tactile maps of the school campus to facility blind and visually impaired people. This was easily by [Touch Mapper](https://touch-mapper.org) tool which an example is [this](https://touch-mapper.org/en/map?map=B99a33b9cdfccd53), which was improved by helpful of association that are working in this field. This assistance was crucial for adding Braille information about buildings  and other areas providing a ‘vision’ to who cannot see.
